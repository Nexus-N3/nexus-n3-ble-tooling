    ...
    def _observe_json(self, msg: dict[str, Any]):
        ...
        if msg_type == "sensor_disconnected":
            ...
            print(
                ...
                f"first_gateway_ts={msg.get('first_gateway_timestamp_us')} "
                f"last_gateway_ts={msg.get('last_gateway_timestamp_us')} "
    ...
    def summary(self):
        ...
        for address in sorted(self.stats):
            ...
            print(
                ...
                f"gateway_first_timestamp_us={gateway_stats.get('first_gateway_timestamp_us')} "
                f"gateway_last_timestamp_us={gateway_stats.get('last_gateway_timestamp_us')} "
